...
def get_scale():
    d = pd.read_csv('/home/lzy/lab/Project/TaihuData/Taihu1.csv')
    n_row = d.shape[0]
    n_col = d.shape[1]
    x = []
    y = []
...
def get_scale2():
    d = pd.read_csv('/home/lzy/lab/Project/TaihuData/svr_model/PingwangDaily_Revise.csv')
    n_row = d.shape[0]
    n_col = d.shape[1]
    x = []
    y = []
...
def get_scale_ignore():
    d = pd.read_csv('/home/lzy/lab/Project/TaihuData/svr_model/pingwang_day.csv')
    n_row = d.shape[0]
    n_col = d.shape[1]
    x = []
    y = []
...
def get_train_test_json(x, y):
    ...
    for i in range(n_row):
        if i < train_sum:
            ...
            test_x.append(x[i][:])
            test_y.append(y[i])
    fw_train_x = open('/home/lzy/lab/Project/TaihuData/svr_model/pingwang_train_x4.csv','w')
    fw_train_y = open('/home/lzy/lab/Project/TaihuData/svr_model/pingwang_train_y4.csv','w')
    fw_test_x = open('/home/lzy/lab/Project/TaihuData/svr_model/pingwang_test_x4.csv','w')
    fw_test_y = open('/home/lzy/lab/Project/TaihuData/svr_model/pingwang_test_y4.csv','w')
...
def svr_testing(modelFilePath, testFilePath_x, testFilePath_y, testResultPath):
    ...
    fw_pred = open('/home/lzy/lab/Project/TaihuData/svr_model/day_data/result/predictResult4.json','w')
...
def overall_for():
    trainFilePath_x = "/home/lzy/lab/Project/TaihuData/svr_model/pingwang_train_x4.csv"
    trainFilePath_y = "/home/lzy/lab/Project/TaihuData/svr_model/pingwang_train_y4.csv"
    modelFilePath = "/home/lzy/lab/Project/TaihuData/svr_model/day_data/model/model4.pkl"
    parametersFilePath = "/home/lzy/lab/Project/TaihuData/svr_model/day_data/model/parameters4.npy"
    testFilePath_x = "/home/lzy/lab/Project/TaihuData/svr_model/pingwang_test_x4.csv"
    testFilePath_y = "/home/lzy/lab/Project/TaihuData/svr_model/pingwang_test_y4.csv"
    testResultPath = "/home/lzy/lab/Project/TaihuData/svr_model/day_data/result/testResult4.txt"
    validationFilePath = "/home/lzy/lab/Project/TaihuData/svr_model/day_data/result/validation4.txt"
    # # 训练模型
...
def get_para():
    para = np.load('/home/lzy/lab/Project/TaihuData/svr_model/day_data/model/parameters2.npy',allow_pickle=True)
    print(para)

def get_RMSE():
    fr = open('/home/lzy/lab/Project/TaihuData/svr_model/day_data/result/validation.txt','r')
    fw = open('/home/lzy/lab/Project/TaihuData/svr_model/day_data/result/rmse.txt','w')
    for l in fr:
        temp = l.split("|")
...
def get_all_data(x, y):
    ...
    for i in range(n_row):
        train_x.append(x[i][:])
        train_y.append(y[i])
    fw_train_x = open('/home/lzy/lab/Project/TaihuData/svr_model/pingwang_all_x3.csv','w')
    fw_train_y = open('/home/lzy/lab/Project/TaihuData/svr_model/pingwang_all_y3.csv','w')
    json.dump(train_x,fw_train_x)
    json.dump(train_y,fw_train_y)
...
def svr_test_all(modelFilePath, testFilePath_x, testFilePath_y, testResultPath):
    ...
    pred = model.predict(vector)
    pred_list = pred.tolist()
    fw_pred = open('/home/lzy/lab/Project/TaihuData/svr_model/day_data/result/predict_all3.json','w')
    json.dump(pred_list,fw_pred)

def get_all_test_result():
    modelFilePath = "/home/lzy/lab/Project/TaihuData/svr_model/day_data/model/model3.pkl"
    testFilePath_x = "/home/lzy/lab/Project/TaihuData/svr_model/pingwang_all_x3.csv"
    testFilePath_y = "/home/lzy/lab/Project/TaihuData/svr_model/pingwang_all_y3.csv"
    testResultPath = "/home/lzy/lab/Project/TaihuData/svr_model/day_data/result/testResult3.txt"
    
    svr_test_all(modelFilePath, testFilePath_x, testFilePath_y, testResultPath)

def write_txt():
    fr = open('/home/lzy/lab/Project/TaihuData/svr_model/day_data/result/predict_all3.json','r')
    fw = open('/home/lzy/lab/Project/TaihuData/svr_model/day_data/result/predict_all3.txt','w')
    s = json.load(fr)
    for l in s:
        fw.write(str(l)+"\n")
    fw.close()
